...
# 使用 ModelScope
python main.py --base-url https://api-inference.modelscope.cn/v1 --model "ZhipuAI/AutoGLM-Phone-9B" --apikey "ms-ce70714e-5708-48e7-a569-e74b133c8a4a" "打开美团搜索附近的火锅店"
```
